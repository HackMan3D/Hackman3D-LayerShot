...
rm -f "$ROOT/releases/Hackman3D-LayerShot-macOS-1.2.8.zip"
...
ditto -c -k --norsrc --keepParent \
  ...
  "$CLEAN_DIR/Hackman3D-LayerShot-macOS-1.2.8.zip"
ditto --norsrc "$CLEAN_DIR/Hackman3D-LayerShot-macOS-1.2.8.zip" \
  "$ROOT/releases/Hackman3D-LayerShot-macOS-1.2.8.zip"
echo "Created releases/Hackman3D LayerShot.app"
echo "Created releases/Hackman3D-LayerShot-macOS-1.2.8.zip"
