...
Compress-Archive -Path "dist\Hackman3D LayerShot\*" -DestinationPath "releases\Hackman3D-LayerShot-Windows-0.5.0.zip" -Force
Write-Host "Created releases\Hackman3D-LayerShot-Windows-0.5.0.zip"
